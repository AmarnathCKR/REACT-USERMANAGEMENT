...
var actions_effect_BackgroundRemoval = require('./effect/BackgroundRemoval.cjs');
var actions_effect_DropShadow = require('./effect/DropShadow.cjs');
...
function backgroundRemoval() {
    return new actions_effect_BackgroundRemoval.BackgroundRemoval();
}
/**
 * @summary action
 ...
 */
function dropShadow() {
    return new actions_effect_DropShadow.DropShadow();
}
/**
 *
